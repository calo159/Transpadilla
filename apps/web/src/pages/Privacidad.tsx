...
export default function Privacidad() {
  ...
  return (
    <LegalPage titulo="Política de Privacidad" actualizado="Junio de 2026">
      <LegalP>
        TransPadilla es un sistema de información de transporte público en
      ...
      <LegalP>Como titular de datos puedes ejercer tus derechos de <strong>acceso, rectificación,
        ...
        ejercerlos, escríbenos por WhatsApp al {WHATSAPP_NUMERO}. Responderemos en los términos y plazos que fija la ley.</LegalP>
