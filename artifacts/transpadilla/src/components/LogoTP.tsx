  ...
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g clipPath="url(#tp-clip)">
        ...
        {/* Sol amarillo */}
        <circle cx="60" cy="55" r="15" fill="#F5C200" />
        ...
        <path d="M-5 88 Q35 72 64 80 Q95 88 125 76 L125 120 L-5 120 Z" fill="#0D2461" />
        {/* Carretera amarilla en perspectiva */}
        <path d="M60 70 L50 120 L70 120 Z" fill="#F5C200" opacity="0.95" />
...
export function LogoTPFull({
  ...
  const textColor = dark ? "#0D2461" : "white";
  return (
    <div className="flex items-center gap-3">
      <LogoTP size={size} />
      <div className="leading-tight">
        <p className="font-black tracking-wide" style={{ fontSize: size * 0.34, color: textColor }}>
          Trans<span style={{ color: "#4BA9D8" }}>Padilla</span>
        </p>
        <p className="font-semibold tracking-[0.18em] uppercase" style={{ fontSize: size * 0.14, color: "#F5C200" }}>
          Moviendo la Ciudad
        </p>
      </div>
    </div>
